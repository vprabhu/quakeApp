...
public final class QueryUtils {
     ...
     */
    private static ArrayList<Info> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            JSONArray mFeaturesArray = mJsonObject.getJSONArray("features");
            int size = mFeaturesArray.length();
            for (int i = 0; i < size; i++) {
                JSONObject mPropertiesJsonObject  = mFeaturesArray.getJSONObject(i).getJSONObject("properties");
                Info mInfo = new Info(
                        mPropertiesJsonObject.getDouble("mag") ,
                        mPropertiesJsonObject.getString("place"),
                        mPropertiesJsonObject.getLong("time") ,
                        mPropertiesJsonObject.getString("url"));
                earthquakes.add(mInfo);
            }
    ...
    public static List<Info> fetchEarthquakeData(String requestUrl) {
        ...
        List<Info> earthquake = extractEarthquakes(jsonResponse);
